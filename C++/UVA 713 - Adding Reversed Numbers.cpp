...
Bigint numReverse(Bigint number)
{

    Bigint reverseNum,zeroNum,tenNum,temp;
    string zero="0",ten="10";
    reverseNum=zero;
    zeroNum=zero;
    tenNum=ten;
    ...
    {
        temp=number%tenNum;
        reverseNum=reverseNum*tenNum+temp;
        number=number/tenNum;
    }
    return (reverseNum);
}
